...
class IndicatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indicator" do
    assert_difference("Indicator.count") do
      post indicators_url, params: { indicator: { mechanism_id: @indicator.mechanism_id, name: @indicator.name, values: @indicator.values } }
    end
  ...
  test "should update indicator" do
    patch indicator_url(@indicator), params: { indicator: { mechanism_id: @indicator.mechanism_id, name: @indicator.name, values: @indicator.values } }
