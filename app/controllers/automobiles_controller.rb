class AutomobilesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @automobile.save
        format.html { redirect_to automobile_url(@automobile), notice: "Automobile was successfully created." }
  ...
  def update
    respond_to do |format|
      if @automobile.update(automobile_params)
        format.html { redirect_to automobile_url(@automobile), notice: "Automobile was successfully updated." }
  ...
  private
    ...
    def automobile_params
      params.require(:automobile).permit(:name, :price, :horse_power)
    end
end
